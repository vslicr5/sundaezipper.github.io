...
document.addEventListener("keydown", (e) => {
  ...
  if (e.key === "r" || e.key === "R") {
    ...
    if (window._reloading) {
      ...
      window.reloadAssets()
        .then(ok => { if (ok) showToast("Assets reloaded!"); window.scrollTo({ top: savedY, behavior: "instant" }); })
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const LOCAL_QUOTES = [
    ...
    ":stickman/spazz::stickman/spazz::stickman/spazz::stickman/spazz:",
    ...
    ":nintendo/dance::nintendo/dance::nintendo/dance::nintendo/dance:",
  ...
  const setQuote = () => {
    box.innerHTML = parseQuoteWithImages(
